...
This folder is for people who build and change CollabMD. If you run or
operate a workspace, start with the [operator docs](../../README.md#docs)
instead.
...
Rule of thumb: decisions get an ADR; operator-visible impact also gets an
update to the matching doc under `docs/`.
