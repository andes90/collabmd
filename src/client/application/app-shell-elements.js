export function bindAppShellElements(doc = document) {
  return {
    ...
    hostedGate: doc.getElementById('hostedGate'),
    teamSettingsButton: doc.getElementById('teamSettingsBtn'),
    teamSettingsContent: doc.getElementById('teamSettingsContent'),
    teamSettingsDialog: doc.getElementById('teamSettingsDialog'),
